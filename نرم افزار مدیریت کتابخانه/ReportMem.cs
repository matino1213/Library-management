...
{
    public partial class ReportMem : Form
    {
        public ReportMem()
        {
            InitializeComponent();
        ...
        DateTime date2;
        bool flagg = false;
        public ReportMem(DateTime d1, DateTime d2)
        {
            date1 = d1;
            date2 = d2;
            flagg = true;
        ...
        private void ReportMem_Load(object sender, EventArgs e)
        {
            if (flagg)
            {
        ...
        private void textBox1_TextChanged(object sender, EventArgs e)
        {
            ...
            cmbChooseDate.Text = "";
            dataGridView1.DataSource = null;
            dataGridView1.DataSource = blr.Read(txtSearch.Text, flag);
        }
        ...
        private void comboBox1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                this.Close();
                AddDate a = new AddDate(2);
                a.Show();
            }
        }

        private void ReportMem_FormClosed(object sender, FormClosedEventArgs e)
        {
            BlReportMem blr = new BlReportMem();
            blr.UpdateAll();
        }
        ...
        {
            cmbChooseClass.DataSource = null;
            cmbChooseClass.Enabled = false;
            BlReportMem blr = new BlReportMem();
            flag = "متفرقه";
            dataGridView1.DataSource = null;
            dataGridView1.DataSource = blr.ReadFilter(flag);
        ...
        {
            BlReportMem blr = new BlReportMem();
            cmbChooseClass.DataSource = blr.Class();
            cmbChooseClass.DisplayMember = "ClassName";
            cmbChooseClass.Enabled = true;
            dataGridView1.DataSource = null;
            dataGridView1.DataSource = blr.ReadClass(cmbChooseClass.Text);
            txtSearch.Text = "";
        ...
        {
            BlReportMem blr = new BlReportMem();
            flag = cmbChooseClass.Text;
            dataGridView1.DataSource = null;
            dataGridView1.DataSource = blr.ReadClass(flag);
        }
        string date;
        private void CreatePDF(string Address)
        {
            ...
            PdfPCell pdfc = new PdfPCell(new Phrase("گزارش نفرات برتر در تاریخ " + date, tahoma));
